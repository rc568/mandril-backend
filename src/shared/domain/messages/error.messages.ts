export const errorMessages = {
  ...
  order: {
    ...
    cannotSetStatusOfCompletedOrder: 'No se puede cambiar el estado de una venta completada.',
    cannotModifyExistingInvoice: 'No se puede modificar los datos de facturación existentes.',
    cannotModifyProductsInNotSaleOrder: 'No se puede modificar los productos de una orden de devolución.',
